...
set "OPTS=-O2 -Ivendor_win10\include -Ivendor\lua-5.1.5\src"
...
REM ----------------------------------------------------------------
echo Linking...
%GPP% %OBJDIR%\main.o %OBJDIR%\sdl_main.o %OBJDIR%\lua.o %OBJDIR%\vorbis.o -o Find5_w10.exe -Lvendor_win10\lib -lmingw32 -lSDL -lopengl32 -lOpenAL32 -static-libgcc -static-libstdc++
if errorlevel 1 goto error
